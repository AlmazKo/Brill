...
/**
 * Класс для работы с utf8 строками
 * взято из Joomla
 *
 * @author almaz
 */
class StringUtf8 {
     ...
     * @subpackage strings
     */
    private static $utf8LowerToUpper = array(
     ...
     * @see http://dev.splitbrain.org/view/darcs/dokuwiki/inc/utf8.php
     */
    private static $utf8LowerToLower = array(
     ...
     * @author <chernyshevsky@hotmail.com>
    ...
    public static function strtoupper($string){
        $uni = Encoding::utf8_to_unicode($string);
        if (!$uni) {
            return FALSE;
        }
        ...
        $cnt = count($uni);
        for ($i=0; $i < $cnt; $i++){
            if( isset(self::$utf8LowerToUpper[$uni[$i]]) ) {
                $uni[$i] = self::$utf8LowerToUpper[$uni[$i]];
            }
        }
    ...
    public static function strtolower($string){
        ...
        $cnt = count($uni);
        for ($i=0; $i < $cnt; $i++){
            if ( isset(self::$utf8LowerToLower[$uni[$i]]) ) {
                $uni[$i] = self::$utf8LowerToLower[$uni[$i]];
            }
        }
        return Encoding::utf8_from_unicode($uni);
    }
