...
/**
 * General
 * Основые константы а также евент-машина
 * @todo разделить евен машину от сборищка классво както 
 * Класс основных перменных и констант
 * @author almazko
 */

class General {
    //основные эвенты(названия), остальные надо регистрировать
    const
    ...
    public static
        //модуль по умолчанию
        $defaultModule,
        // родительский модуль по умолчанию
        $defaultParentModule,
